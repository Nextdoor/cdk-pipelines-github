...
| <code><a href="#@nextdoor/cdk-pipelines-github.OpenIdConnectProviderProps.property.sessionDuration">sessionDuration</a></code> | <code>number</code> | The maximum time that the session should be valid for. |
...
##### `sessionDuration`<sup>Optional</sup> <a name="sessionDuration" id="@nextdoor/cdk-pipelines-github.OpenIdConnectProviderProps.property.sessionDuration"></a>
...
The maximum time that the session should be valid for.
